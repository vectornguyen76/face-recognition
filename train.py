...
# weight = torch.load("arcface/resnet18_backbone.pth", map_location = device)
# model_emb = iresnet18()
...
def training(
    ...
    # Save features
    np.savez_compressed(features_save_dir, arr1=images_name, arr2=images_emb)
...
def parse_opt():
    ...
    parser.add_argument(
        "--full-training-dir",
        type=str,
        default="./database/full-training-datasets/",
        help="dir folder full training",
    )
    parser.add_argument(
        "--additional-training-dir",
        type=str,
        default="./database/additional-training-datasets/",
        help="dir folder additional training",
    )
    parser.add_argument(
        "--faces-save-dir",
        type=str,
        default="./database/face-datasets/",
        help="dir folder save face features",
    )
    parser.add_argument(
        "--features-save-dir",
        type=str,
        default="./static/feature/face_features",
        help="dir folder save face features",
    )
    parser.add_argument(
        "--is-add-user", type=bool, default=True, help="Mode add user or full training"
    )
